...
public partial class ReactiveHamburgerMenu : TabControl
{
    private SplitView? _splitView;

    public static readonly StyledProperty<IBrush?> PaneBackgroundProperty =
        SplitView.PaneBackgroundProperty.AddOwner<ReactiveHamburgerMenu>();
    ...
    public static readonly StyledProperty<IBrush?> ContentBackgroundProperty =
        AvaloniaProperty.Register<ReactiveHamburgerMenu, IBrush?>(nameof(ContentBackground));
    ...
    public static readonly StyledProperty<int> ExpandedModeThresholdWidthProperty =
        AvaloniaProperty.Register<ReactiveHamburgerMenu, int>(nameof(ExpandedModeThresholdWidth), 1008);
